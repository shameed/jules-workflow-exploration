...
using Baic.AuthMain.Data;
using Baic.AuthMain.Resources;
using Baic.AuthMain.Services;
using Baic.AuthMain.Filters;
using Baic.AuthMain.Services.Certificate;
using Serilog;
...
using AutoMapper;
using Baic.AuthMain.MappingProfiles;
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            config.AddProfile<AuthMappingProfiles>();
        });


        services.AddTransient<IProfileService, IdentityWithAdditionalClaimsProfileService>();
        services.AddTransient<IInspireUser, InspireUser>();
        ...
        services.AddDbContext<ApplicationDbContext>(options =>
            options.UseSqlServer(_configuration.GetConnectionString("IdentityServerDB")));
        ...
        // TODO: Keep this code for  Password less login
        //.AddTokenProvider<Fifo2UserTwoFactorTokenProvider>("FIDO2");  

        services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme);

        // TODO: Keep this code for  Azure Ad login
        ...
        var identityServer = services.AddIdentityServer()
            ...
            .AddAspNetIdentity<IdentityUserExtended>()
